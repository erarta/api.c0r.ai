...
TRANSLATIONS = {
    ...
    "scan_barcode_prompt": "📷 Let's scan a barcode together!\n\nHow to get the best result:\n- Hold the phone steady and fill the frame with the barcode\n- Make sure it’s well lit and not blurry\n- Barcodes are the black-and-white stripes on the package (or small square QR-like)\n\nI’m ready when you are — send the photo!",
    ...
    "scan_found_but_not_off": "I found a barcode, but the product is not in OpenFoodFacts yet.",

...
TRANSLATIONS = {
    ...
    "scan_barcode_prompt": "📷 Photograph the product package\n\nHow to get the best result:\n- Show the front and the nutrition/ingredients panel\n- Good lighting, avoid glare and blur\n- Fill the frame with the package, keep the phone steady\n- Barcode is optional (helpful if visible)\n\nI’m ready — send the photo!",
    ...
    # OpenFoodFacts removed; generic placeholder kept for future use if needed
    "scan_tips": "I couldn't read a barcode. Try again with good lighting and fill the frame with the barcode.",
    "scan_try_again_btn": "🔁 Try again",
}
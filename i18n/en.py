...
TRANSLATIONS = {
    # Welcome messages
    "welcome_title": "🎉 **Welcome to c0r.ai!**",
    "welcome_greeting": "👋 Hello {name}!",
    "welcome_credits": "💳 You have **{credits} credits** remaining",
    "welcome_features": "🍎 **My main features:**",
    "welcome_feature_1": "🍽️ **Create recipes from photos** - show ingredients, get personalized recipes",
    "welcome_feature_2": "📊 **Analyze food from photos** - discover calories, protein, fats, carbs",
    "welcome_feature_3": "🎯 **Personalization** - considers your goals, diet, and allergies",
    "welcome_ready": "🚀 **Ready to start?** Choose what you want to do:",
    ...
    "btn_get_recipe": "🍽️ Create Recipe from Your Photo",
    "btn_back": "⬅️ Back",
}
TRANSLATIONS.update({
    # Help messages
    ...
    "help_commands_6": "• /recipe - Generate personalized recipes from photos",
    "help_commands_7": "• /daily - View daily nutrition plan & progress",

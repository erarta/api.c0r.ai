    ...
    def _load_translations(self) -> Dict[str, Dict[str, str]]:
        ...
        return {
            ...
            Language.RUSSIAN.value: {
                ...
                "activity_sedentary": "😴 Малоподвижный (нет/минимум упражнений)",
                "activity_lightly_active": "🚶 Немного активный (легкие упражнения 1-3 дня/нед)",
                "activity_moderately_active": "🏃 Умеренно активный (умеренные упражнения 3-5 дней/нед)",
                "activity_very_active": "💪 Очень активный (тяжелые упражнения 6-7 дней/нед)",
                "activity_extremely_active": "🏋️ Чрезвычайно активный (очень тяжелая физнагрузка, физическая работа)",
                "activity_not_set": "Не указано",
                "goal_lose_weight": "📉 Похудение",
                "goal_maintain_weight": "⚖️ Поддержание веса",
                "goal_gain_weight": "📈 Набор веса",
                "goal_not_set": "Не указано",
                "calories_not_calculated": "Не рассчитано",
